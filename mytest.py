...
def run_test_file():
    ...
    plt.plot(left_speeds, label="l_speeds", color="blue")
    plt.plot(right_speeds, label="r_speeds", color="orange")
    plt.axhline(target_speed, linestyle="--")
    plt.plot(left_signals, label="l_signals", linestyle=":", color="blue")
    plt.plot(right_signals, label="r_signals", linestyle=":", color="orange")
